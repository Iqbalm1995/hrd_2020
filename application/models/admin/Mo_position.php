...
class Mo_position extends CI_Model {
	...
	var $table_position = 'div_position';
	...
	var $column_search = array('pos_name'); //set column field database for datatable searchable just firstname , lastname , address are searchable
	var $order = array('pos_name' => 'asc'); // default order 
	...
	{
		return $this->db->get($this->table_position)->result();
	}
	...
	{
		$this->db->update($this->table_position, $data, $where);

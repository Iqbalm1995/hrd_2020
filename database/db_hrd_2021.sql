...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2021 at 06:57 AM
...
--
ALTER TABLE `perekrutan`
  MODIFY `rekrut_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tes_perekrutan`
  ADD CONSTRAINT `tes_perekrutan_ibfk_1` FOREIGN KEY (`rekrut_id`) REFERENCES `perekrutan` (`rekrut_id`) ON DELETE CASCADE ON UPDATE CASCADE,

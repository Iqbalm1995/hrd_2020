...
MySQL - 10.1.37-MariaDB : Database - jicoagun_rekrutmen
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`jicoagun_rekrutmen` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `jicoagun_rekrutmen`;
